...
#q1
--------------------------------
select candfname,candfname,date(candbirthdate) from candidate;
---------------------------------
select candfname,candlname,candaddr1,candaddr2 from candidate as cd,candaddr as cdr where cd.candid=cdr.candid;
-----------------------------------
select qualid,examname,boardname from candqual;
-------------------------------------
select * from client;
------------------------------------
select cname,clntaddr1,clntaddr2 from client as cl,clntaddr as cdr where cl.clntid=cdr.clntid; 
-------------------------------------
select * from candidate as cd,candqual as cq where cd.candid=cq.candid and cq.yearofpassinng < 2001;
--------------------------------------
...
-------------------------------------
update clntaddr set clntcity="pune" where clntcity="mumbai";
-------------------------------------
update clntaddr set clntcountry="India" ;
-------------------------------------
update candqual as cq,candidate as cd set cq.class="first" where cq.candid=cd.candid and cd.candfname="l";
-------------------------------------

#q3
delete from clntaddr as cdr, clntcontmod as ccm where cdr.clntaddrid = ccm.clntaddrid and cdr.clntstate="maharastra";
